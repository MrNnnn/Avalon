...
<%@ page import="com.fate.entity.Menu" %>
<!DOCTYPE html>
<%
	StringBuffer html = new StringBuffer("<ul class=\"nav nav-list\">");
	Menu menu = (Menu)request.getAttribute("menu");
	String str = build(menu,html)+"</ul>";
%>
<%!
 	public String build(Menu menu,StringBuffer html){
		for(Menu chiled:menu.getChildMenu()){
			if(chiled.getParentId()==1){
				html.append("<li class=\"\"><a class=\"dropdown-toggle\" href=\"").append(chiled.getUrl())
				.append("\"><i class=\"menu-icon fa fa-tachometer\"></i><span class=\"menu-text\">")
				.append(chiled.getTitle()).append("</span></a><b class=\"arrow\"></b>");
			}else
			if(!chiled.getChildMenu().isEmpty()){
				html.append("<li class=\"\"><a class=\"dropdown-toggle\" href=\"").append(chiled.getUrl())
				.append("\"><i class=\"menu-icon fa fa-caret-right\"></i>")
				.append(chiled.getTitle()).append("</a><b class=\"arrow fa fa-angle-down\"></b>");
			}else{
				html.append("<li class=\"\"><a class=\"\" href=\"").append(chiled.getUrl())
				.append("\"><i class=\"menu-icon fa fa-caret-right\"></i>")
				.append(chiled.getTitle()).append("</a><b class=\"arrow fa fa-angle-down\"></b>");
			}
			if(!chiled.getChildMenu().isEmpty()){
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<div id="main" style="height:400px" class="col-sm-7">
		...
		<script type="text/javascript">
	        ...
	        require(
	            ...
	            function (ec) {
	                ...
	                myChart.on(ecConfig.EVENT.CLICK, layerOpen);
	            }
	        );
		</script>
